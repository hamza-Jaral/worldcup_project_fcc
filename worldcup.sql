...
--
-- Name: games fk_loser; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT fk_loser FOREIGN KEY (opponent_id) REFERENCES public.teams(team_id);
